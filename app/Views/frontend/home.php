...
<head>
  ...
  <style>
    ...
    .logo-link:hover { text-decoration:none; color:var(--hs-primary); }

    .logo-mark {
      width:32px;
      height:32px;
      border-radius:14px;
      background: radial-gradient(circle at 18% 0, #38BDF8 0, #2563EB 45%, #0B3B8C 100%);
      display:flex;
      align-items:center;
    ...
    .logo-text-tag { font-size:11px; color:var(--hs-muted); opacity:.85; }
    ...
    .nav-main a:hover { background:rgba(37, 99, 235, 0.12); color:var(--hs-primary); text-decoration:none; }
    ...
    .nav-categories .chip:hover { background:#DBEAFE; color:var(--hs-primary); text-decoration:none; }

    .category-ribbon {
      width:100%;
      background:#FFFFFF;
      border-bottom:1px solid var(--hs-border);
      box-shadow:0 18px 38px rgba(37,99,235,0.06);
    }
    ...
    .language-switcher { min-width:140px; padding:9px 10px; border-radius:10px; border:1px solid rgba(148,163,184,0.5); background:#EFF6FF; color:#E5E7EB; }
    .language-label { font-size:11px; color:#E5E7EB; opacity:0.75; }

    .user-bar { font-size:11px; color:#E5E7EB; text-align:right; }
    .user-bar a { color:#0EA5E9; }
    ...
    @media (max-width:960px) {
      ...
      .nav-main a { width:100%; padding:10px; border-radius:12px; background:rgba(255,255,255,0.92); }
    ...
    .ticker {
      ...
      background:linear-gradient(90deg, rgba(15,23,42,0.12), rgba(37,99,235,0.14));
      overflow-x:auto;
      white-space:nowrap;
    }
    .ticker-label {
    ...
    .hero-main {
      ...
      background:
        ...
        linear-gradient(135deg, #E8EEF9, #E8EEF9);
      min-height:190px;
      display:flex;
      flex-direction:column;
      justify-content:flex-end;
    ...
    .hero-title {
      ...
      margin-bottom:4px;
      color:var(--hs-text);
      text-shadow:0 8px 25px rgba(15,23,42,0.12);
    }
    .hero-meta {
      font-size:12px;
      color:var(--hs-muted);
    ...
    .slider-slide {
      ...
      padding:18px;
      box-sizing:border-box;
      background:linear-gradient(135deg, rgba(255,255,255,0.97), rgba(255,255,255,0.96));
    }
    ...
    .slider-placeholder {
      ...
      border-radius:16px;
      background:radial-gradient(circle at 20% 20%, rgba(99,102,241,0.35), rgba(255,255,255,0.97));
      color:#E2E8F0;
      display:flex;
      align-items:center;
      justify-content:center;
    ...
    .slider-kicker { font-size:11px; letter-spacing:.18em; color:#0EA5E9; text-transform:uppercase; }
    .slider-title { font-size:24px; font-weight:800; color:#F9FAFB; line-height:1.2; }
    .slider-title { font-size:24px; font-weight:800; color:var(--hs-text); line-height:1.2; }
    .slider-meta { font-size:13px; color:var(--hs-muted); display:flex; gap:10px; flex-wrap:wrap; }
    .slider-excerpt { font-size:13px; color:var(--hs-muted); line-height:1.5; max-width:58ch; }
    .slider-nav {
      position:absolute;
      right:16px;
      bottom:16px;
    ...
    .slider-dot.is-active { background:#0EA5E9; border-color:#0EA5E9; }
    ...
    .slider-mini-placeholder {
      ...
      background:linear-gradient(135deg, rgba(99,102,241,0.3), rgba(15,23,42,0.12));
    ...
    .gallery-thumb {
      ...
      height:28px;
      border-radius:8px;
      background: radial-gradient(circle at top, rgba(250,204,21,0.28), rgba(255,255,255,0.97));
      display:flex;
      align-items:center;
      justify-content:center;
      font-size:14px;
    ...
    footer {
      ...
      color:#9CA3AF;
      text-align:center;
      background:linear-gradient(180deg, rgba(37,99,235,0.08), #E8EEF9);
    }
      ...
      <div class="card" id="regions">
        ...
        <div class="region-row">
          <div class="region-block" id="india">
            <div class="region-header">
              <span>India</span>
              <span><a href="<?= hs_category_url('india') ?>" style="color:#0EA5E9;">View All</a></span>
            </div>
          ...
          <div class="region-block" id="gcc">
            <div class="region-header">
              <span>GCC</span>
              <span><a href="<?= hs_category_url('gcc') ?>" style="color:#0EA5E9;">View All</a></span>
            </div>
          ...
          <div class="region-block" id="kerala">
            <div class="region-header">
              <span>Kerala</span>
              <span><a href="<?= hs_category_url('kerala') ?>" style="color:#0EA5E9;">View All</a></span>
            </div>
        ...
        <div class="region-row" style="margin-top:10px;">
          <div class="region-block" id="world">
            <div class="region-header">
              <span>World</span>
              <span><a href="<?= hs_category_url('world') ?>" style="color:#0EA5E9;">View All</a></span>
            </div>
          ...
          <div class="region-block" id="sports">
            <div class="region-header">
              <span>Sports</span>
              <span><a href="<?= hs_category_url('sports') ?>" style="color:#0EA5E9;">View All</a></span>
            </div>
