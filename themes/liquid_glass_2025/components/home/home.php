<div class="home-grid">
    <div class="home-main">
        ...
        <?php include __DIR__ . '/featured_slider.php'; ?>
        ...
        <?php include __DIR__ . '/category_highlights.php'; ?>
        <?php include __DIR__ . '/world_regions.php'; ?>
        <?php include __DIR__ . '/videos_live.php'; ?>
        <?php include __DIR__ . '/trending_slider.php'; ?>
    ...
    <aside class="home-rail">
        ...
        <?php include __DIR__ . '/video_widget.php'; ?>
