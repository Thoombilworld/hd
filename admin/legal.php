...
<head>
  ...
  <link rel="stylesheet" href="<?= hs_base_url('assets/summernote/summernote-lite.css') ?>">
  <link rel="stylesheet" href="<?= hs_base_url('assets/summernote/summernote-dark.css') ?>">
  ...
  <script src="<?= hs_base_url('assets/summernote/cleaner.js') ?>"></script>
  <script src="<?= hs_base_url('assets/summernote/summernote-lite.js') ?>"></script>
  <style>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      initSummernote('.summernote', {
        uploadUrl: '<?= hs_base_url('admin/upload/image.php') ?>',
        theme: 'light'
      });
    });
  </script>
