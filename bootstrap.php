...
function hs_admin_nav_links($role, $active = '')
{
    $links = [
        ...
        ['key' => 'themes',    'label' => 'Themes',    'href' => hs_base_url('admin/theme/index.php'), 'roles' => ['admin']],
        ['key' => 'menus',     'label' => 'Menus',     'href' => hs_base_url('admin/menus.php'), 'roles' => ['admin']],
        ['key' => 'widgets',   'label' => 'Widgets',   'href' => hs_base_url('admin/widgets.php'), 'roles' => ['admin']],
        ['key' => 'media',     'label' => 'Media',     'href' => hs_base_url('admin/media.php'), 'roles' => ['admin', 'editor']],
