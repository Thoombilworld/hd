...
<head>
  ...
  <style>
    ...
    body {
      ...
      background: radial-gradient(circle at top, #1E3A8A 0, #E8EEF9 45%, #E8EEF9 100%);
      color: #F9FAFB;
    }
    ...
    .logo-link:hover { color:#0EA5E9; text-decoration:none; }
    .logo-mark {
      width:32px; height:32px; border-radius:14px;
      background: radial-gradient(circle at 20% 0, #0EA5E9 0, #1E3A8A 45%, #E8EEF9 100%);
    ...
    .logo-text-tag { font-size:11px; color:var(--hs-text); opacity:.85; }

    .nav-toggle { display:none; align-items:center; justify-content:center; width:40px; height:40px; border-radius:12px; border:1px solid rgba(148,163,184,0.6); background:rgba(37,99,235,0.12); color:var(--hs-text); cursor:pointer; }
    ...
    .nav-main a { color:var(--hs-text); padding:6px 8px; border-radius:999px; }
    .nav-main a:hover { background:rgba(37,99,235,0.12); color:#0EA5E9; text-decoration:none; }
    ...
    .language-switcher { min-width:120px; padding:6px 10px; border-radius:10px; border:1px solid rgba(148,163,184,0.5); background:#EFF6FF; color:var(--hs-text); }

    .user-bar { font-size:11px; color:var(--hs-text); text-align:right; }
    ...
    .breadcrumb a:hover { color:#0EA5E9; text-decoration:none; }
    ...
    .pill { display:inline-flex; align-items:center; gap:6px; padding:6px 10px; border-radius:12px; font-size:12px; background:#0F172A; color:var(--hs-text); border:1px solid rgba(15,23,42,0.2); box-shadow:0 10px 30px rgba(15,23,42,0.2); }
    ...
    .article-nav a { display:block; background:#0F172A; color:var(--hs-text); padding:10px 12px; border-radius:12px; border:1px solid rgba(15,23,42,0.25); box-shadow:0 10px 32px rgba(15,23,42,0.25); width:100%; }
    .article-nav a:hover { background:#111827; text-decoration:none; color:#0EA5E9; }
    ...
    .sidebar-list a { color:var(--hs-text); }
    .sidebar-list a:hover { color:#0EA5E9; text-decoration:none; }
    ...
    footer {
      ...
      color:#9CA3AF;
      text-align:center;
      background:linear-gradient(180deg, rgba(15,23,42,0.98), #E8EEF9);
    }
    .footer-links { margin-bottom:6px; }
    .footer-links a { color:var(--hs-text); }
  ...
  <?= $render_ad('article_top', hs_t('advertisement', 'Advertisement')) ?>
    ...
    <aside class="sidebar">
      ...
      <section class="sidebar-card">
        ...
        <p style="font-size:12px;color:var(--hs-text);">
          <a href="<?= hs_base_url('index.php') ?>" style="color:#0EA5E9;">← Back to homepage</a>
        </p>
      </section>
    </aside>
  </div>
